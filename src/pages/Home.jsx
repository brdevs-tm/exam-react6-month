    ...
    <Fragment>
      <main className="overflow-hidden">
        ...
        <div className="explore-categories container mt-48 flex flex-col gap-10">
          ...
          <div className="categories-row flex justify-between">
            <CategoriesCard />
            <CategoriesCard />
            <CategoriesCard />
            <CategoriesCard />
        ...
        <div className="streaming-devices container mt-40">
          ...
          <div className="streaming-devices-row grid grid-cols-3 gap-5 mt-20">
            <StreamingDevice />
            <StreamingDevice />
            <StreamingDevice />
            <StreamingDevice />
        ...
        <div className="frequently-asked-quests container mt-150px">
          <div className="faq-header flex justify-between">
          ...
          <div className="faq-row grid grid-cols-2 gap-5 mt-20">
            {[...Array(8)].map((_, index) => (
        ...
        <div className="premium-plan container mt-150px">
          <div className="premium-header flex items-end justify-between">
            <div className="flex flex-col gap-14px">
              <span className="text-white text-38px">
                Frequently Asked Questions
              </span>
            ...
            <div className="plan-duration flex items-center border border-black-12 rounded-lg p-2 bg-black">
              <button className="rounded-md px-6 py-4 text-18px text-white transition-all duration-300 hover:bg-black-12">
                Monthly
              </button>
              <button className="rounded-md px-6 py-4 text-18px text-white transition-all duration-300 hover:bg-black-12">
                Yearly
